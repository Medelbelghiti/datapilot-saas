    ...
    <div className="flex min-h-screen">
      <div className="hidden lg:flex lg:w-1/2 bg-brand-600 items-center justify-center p-12">
        <div className="text-center text-white max-w-md">
          ...
          <h2 className="text-3xl font-bold mb-4">Welcome back to DataPilot AI</h2>
          <p className="text-brand-100">Continue turning your data into decisions.</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Link href="/forgot-password" className="block text-sm text-brand-600 hover:underline">
              Forgot password?
            </Link>
